...
for file in metadata.json extension.js selection.js prefs.js ocr.js dependencies.js schemas/org.gnome.shell.extensions.snaptext.arnavk09.gschema.xml; do
    if [ ! -f "$file" ]; then
